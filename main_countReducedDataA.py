...
from Sender.FileSender import FileSender
...
#load tasks
execfile('tasks/task_countReducedDataA.py')
...
if __name__ == '__main__':
    ...
    logFileName = 'processedLogs/merged.custom_log.' + compareLogDateFrom + '.A'
    ...
    serverTask.fileList = [ logFileName ]
